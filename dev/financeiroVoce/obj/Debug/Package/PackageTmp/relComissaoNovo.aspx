<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="relComissaoNovo.aspx.cs"
    Inherits="financeiroVoce.relComissaoNovo" %>
                    ...
                    <tr>
                        ...
                        <td width="700px" align="left">
                            <center><h1>
                                Comissões</h1></center>
                            Treinamento
                            <asp:DropDownList ID="ddlTreinamento" runat="server" Width="200" />
                            <asp:Button ID="btnSelecionarTreinamento" runat="server" Text="Carregar" OnClick="btnSelecionarTreinamento_Click" />
                            - Equipe
                            <asp:DropDownList ID="ddlEquipe" runat="server" Width="170" />
                            <asp:Button ID="btnFiltrarTreinamento" runat="server" Text="Listar" OnClick="btnFiltrarTreinamento_Click" />
                            <br />
                            <asp:LinkButton ID="lnkTodos" runat="server" Text="Listar as comissões de todos os consultores"
                                OnClick="btnImprimir_Click" ForeColor="Red" Visible="false"></asp:LinkButton>
                            <br />
                            <asp:LinkButton ID="lnkCarregarMais" runat="server" Text="Clique aqui para carregar mais treinamentos" OnClick="lnkCarregarMais_OnClick"></asp:LinkButton>
                        </td>
                        <td>
                            <a id="A2" href="relComissao.aspx">Antes de 2016</a> - <a id="A1" href="Default.aspx">
                                Menu Principal</a>
                        </td>
                    </tr>
                </table>
                ...
                <asp:GridView ID="grdTreinandos" runat="server" AutoGenerateColumns="False" Font-Size="10pt"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Crédito/Obs">
                            <ItemTemplate>
                                <asp:Label ID="lblCredito" runat="server" Text='<%# Eval("Credito") %>' Width="100" Font-Size="Smaller"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
