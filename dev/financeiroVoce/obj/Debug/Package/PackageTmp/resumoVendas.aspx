<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="resumoVendas.aspx.cs"
    Inherits="financeiroVoce.resumoVendas" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="upd" runat="server">
            ...
            <asp:TextBox ID="txtDatamax" runat="server" Width="80"></asp:TextBox>
                ...
                <hr />
                <br />
                <h2>Vendas por equipe no período</h2>
                <div id="divLista" runat="server">
                    <asp:GridView ID="grdTreinandos" runat="server" AutoGenerateColumns="False" Font-Size="14pt"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Equipe">
                                <ItemTemplate>
                                    <asp:Label ID="lblNome" runat="server" Text='<%# Eval("Equipe") %>' Width="350"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <hr />
                    <br />
                    <h2>Vendas por Forma de Pagto</h2>
                    ...
                    <hr />
                    <h2>Créditos</h2>
                    <asp:GridView ID="grdFormaCredito" runat="server" AutoGenerateColumns="False" Font-Size="14pt"
                        CellPadding="3" BackColor="White" BorderColor="#CCCCCC" OnRowDataBound="grdFormaCredito_RowDataBound"
                        BorderStyle="None" BorderWidth="1px">
                        <RowStyle ForeColor="#000066" />
                        <Columns>
                            <asp:TemplateField HeaderText="Forma Pagto">
