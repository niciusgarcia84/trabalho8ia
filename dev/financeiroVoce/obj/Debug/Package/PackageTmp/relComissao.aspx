<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="relComissao.aspx.cs" Inherits="financeiroVoce.relComissao" %>

<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Relatório de Comissões - Instituto Você</title>
    ...
    <asp:UpdatePanel ID="upd" runat="server">
        <ContentTemplate>
            ...
            <div id="divLista" runat="server" visible="false">
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Nome">
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hdnMenosSeis" runat="server" />
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:GridView ID="grdSem" runat="server" AutoGenerateColumns="False" Font-Size="10pt" OnRowDataBound="grdSem_RowDataBound"
                ...
                <asp:Label ID="lblTotalTreinandosSem" runat="server" Font-Bold="true" ForeColor="Red"></asp:Label><br /><br />
