<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="imprimirGrupoDiamond.aspx.cs"
    Inherits="financeiroVoce.imprimirGrupoDiamond" %>

<%@ Register TagPrefix="asp" Namespace="AjaxControlToolkit" Assembly="AjaxControlToolkit" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Grupos Treinamentos - Instituto PNL</title>
                        ...
                        <center>
                            <table border="0">
                                <tr>
                                    ...
                                    <td width="500px">
                                        <h1>
                                            <asp:Label ID="lblTreinamento" runat="server"></asp:Label>
                                            - Grupo
